...
const checks = [
  ['syntax', ['--check', path.join(root, 'desktop', 'plugin.js')]],
  ...
  ['project resort gating', [path.join(root, 'test-project-resort-gating.cjs')]],
  ['new-chat arrival sorting', [path.join(root, 'test-new-chat-arrival-sort.cjs')]],
  ['session monitor', [path.join(root, 'test-session-monitor.cjs')]],
  ['monitor new session', [path.join(root, 'test-monitor-new-session.cjs')]],
  ['session order freeze', [path.join(root, 'test-session-order-freeze.cjs')]],
  ['project color flow', [path.join(root, 'test-project-color-flow.cjs')]],
  ['visual hierarchy', [path.join(root, 'test-visual-hierarchy.cjs')]],
